...
<div class="bloque-login-hipic">
	...
	if (user_is_logged_in() == TRUE) {
	 ...
	 print l(t('My account'),"user/".$user->uid."/edit",$options = array('attributes' => array('title' => t('My account'))));
	 print '</div>';
	 
	 
	}
	else {
	 print  l('<img src="/sites/all/themes/hipic/images/logout_img_btn.png"/> '.t('Login or register'),"user/login", $options = array('html' => TRUE,'attributes' => array( 'title' => t('Login or create account'))));
